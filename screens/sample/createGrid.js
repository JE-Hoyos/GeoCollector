...
//   // Función para generar la grilla de puntos
//   const generateGrid = () => {
...
//     const stepLng = degreesToRadians(distance / (111319.9 * Math.cos(degreesToRadians((minY + maxY) / 2))));
//     const stepLat = degreesToRadians(distance / 111319.9);
